...
from src.pipeline.loss_computation.losses_and_grads import get_losses_and_grads
...
def train_step(key, x, params_tup, opt_state_tup, optimiser_tup, fwd_fcn_tup):
    ...
    total_loss, grad_e, grad_g = get_losses_and_grads(
...
def val_step(key, x, params_tup, fwd_fcn_tup):
    ...
    return key, total_loss, grad_mean, grad_var
